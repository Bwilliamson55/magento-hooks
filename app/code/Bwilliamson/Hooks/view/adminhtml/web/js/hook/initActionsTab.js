define([
    'jquery',
    'underscore',
    'Bwilliamson_Hooks/js/lib/codemirror',
    'Magento_Ui/js/modal/modal',
    'mage/translate',
    'Bwilliamson_Hooks/js/mode/xml/xml',
    'Bwilliamson_Hooks/js/addon/display/autorefresh',
    'Bwilliamson_Hooks/js/addon/mode/overlay',
    'jquery/ui'
], function ($, _, CodeMirror, modal, $t) {
    "use strict";
    var payloadUrl = $("#hook_payload_url");
    $.widget('bwilliamson.initActionsTab', {
    ...
    return $.bwilliamson.initActionsTab;
});
